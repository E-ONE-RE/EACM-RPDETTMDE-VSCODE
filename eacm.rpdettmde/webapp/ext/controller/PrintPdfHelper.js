...
// eslint-disable-next-line max-params
    ...
    var SERVICE_ROOT = "/sap/opu/odata4/eacm/ui_rpdettmde_b/srvd/eacm/ui_rpdettmde/0001";
    ...
    async function _downloadBlob(oBlob, sFileName) {
        ...
        oLink.download = sFileName || "CommissionToBeAccrued.pdf";
    ...
    async function _loadPdfFromListReport(oExtensionAPI, mOptions) {
        ...
        return {
            blob: oBlob,
            fileName: (oResult && oResult.FileName) || "CommissionToBeAccrued.pdf"
        };
    }
